...
class GCN(nn.Module):
    ...
    def forward(self, x, edge_index, edge_weight=None):
        # Pass through each layer, with ReLU activation, batch normalization, and dropout
...
def train_gcn(gcn, data, epochs=500, learning_rate=0.01, print_every=10):
    # Optimizer and loss function
    optimizer = torch.optim.Adam(gcn.parameters(), lr=learning_rate)
    criterion = nn.MSELoss()  # We treat this as a regression task on similarity scores
    ...
    for epoch in range(epochs):
        ...
        # Compute predicted similarity between node pairs
    ...
    return gcn  # Return the trained GCN model
...
if __name__ == "__main__":
    ...
    process_gcn(
        ...
        entity_col1='drug1',
        entity_col2='drug2',
        output_file='drug_embeddings_2.pkl',
    ...
    process_gcn(
        ...
        output_file='protein_embeddings_2.pkl',
